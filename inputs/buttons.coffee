...
Template.signUpB3.helpers
      sign: ->
          getSign "Sign Up"

Template.signOutB3.helpers
      sign: ->
          getSign "Sign Out"

Template.signInB3.helpers
      sign: ->
          getSign "Sign In"

Template.b3SignInButton.events
    "click button#b3SignInButton": (e, t)->
        hasErrors = false
        e.preventDefault()
        f= t.firstNode.form
        $f = $ f
...
Template.b3SignUpButton.events
    "click #b3SignUpButton": (e,t) ->
        hasErrors = false
        e.preventDefault()
        f= t.firstNode.form
        $f = $ f
